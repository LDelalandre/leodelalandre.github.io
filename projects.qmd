...
Human's cumulative culture gives rise to rich historical dynamics, characterized by variations in institutions, norms, social organization, as well as technologies. Despite history being to a large extent idiosyncratic, comparative approaches have proposed hypotheses for broad historical patterns. Multiple theories have been proposed to explain the increase in gender inequalities with agriculture, sedentarization, and the development of large, centralized states. I am trying to test some of these hypotheses using anthropological and historical data, and modeling techniques.

I'm additionally sharing my research and broader reflections on a blog, [Making our Nature](https://leodelalandre.substack.com/), where I try to keep posting every two weeks.
...
## 2.2 Can we define a set of (easy-to-implement) good practices to share plant trait data?
